...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::read_pdf,
            commands::relink_document,
            commands::relink_apply_mapping,
            commands::enrich_all,
            ...
            commands::list_notes,
            commands::set_note_collection,
            commands::collection_notes,
            commands::note_counts_by_collection,
            commands::get_note,
            commands::export_note,
            commands::preview_markdown,
            commands::note_export_html,
            ...
            commands::text_from_image_ai,
            commands::mathocr_status,
            commands::ai_unload_models,
            commands::write_text_file,
            commands::write_binary_file,
            commands::save_note_asset,
            commands::import_note_asset,
